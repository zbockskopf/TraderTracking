        ...
        // MARK: - Account Summary
            List{
                Section(header: Text(realmController.account.name)) {
                    ...
                    AccountItemView(name: "P/L", value: realmController.account.profitAndLoss)
                    AccountItemView(name: "Fees", value: realmController.account.fees)
                    AccountItemView(name: "P/L + Fees", value: (realmController.account.profitAndLoss - realmController.account.fees))
                }
                
                // MARK: - Today Stats
                
                Section(header: Text("Today Stats")){
                    AccountItemView(name: showTodayPLandFees ? "P/L + fees" : "P/L", value: {
